import { Droplets, MoveUp, WindIcon } from "lucide-react"
import { Card } from "../ui/card"

export const Wind = ({ speed, degree }: any) => {
    return (
        <Card className="w-full p-4 h-48 justify-between">
            <span className="flex flex-row items-center font-semibold text-sm text-neutral-600 dark:text-neutral-400 tracking-tight gap-2"><WindIcon className="w-[16px]" />Wind</span>

            <div className="relative pb-5 flex h-[10rem] w-[10rem] items-center justify-center md:h-[9rem] md:w-[9rem]">
                ...
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 331 331"
                    style={{ transform: `rotate(${180 + degree}deg)` }}
