...
export const UVIndex = ({ index }: any) => {
    ...
    return (
        <Card className="w-full p-4 h-48 justify-between">
            <span className="flex flex-row font-semibold text-sm text-neutral-600 dark:text-neutral-400 tracking-tight gap-2 mb-4"><Sun className="w-[16px]" />UV Index</span>
